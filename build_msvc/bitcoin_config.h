...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The NASDAC Crypto Coin Core Developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "NASDAC Crypto Coin Core"

/* Copyright year */
#define COPYRIGHT_NDC 2020
...
#define PACKAGE_NAME "NASDAC Crypto Coin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitcoin Core 0.19.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "nasdaccryptocoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://nasdac-cryptocoin.com/"
