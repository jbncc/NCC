 ...
 */
static const char* BITCOIN_PID_FILENAME = "nasdaccryptocoind.pid";
...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-emergencystaking=<n>", "Enable or disable emergecy staking. 0 = disabled, 1 = enabled (default: disabled)", ArgsManager::ALLOW_ANY, OptionsCategory::BLOCK_CREATION);
    gArgs.AddArg("-aggressivestaking", "Check more often to publish immediately when valid block is found.", ArgsManager::ALLOW_ANY, OptionsCategory::BLOCK_CREATION);
    ...
    gArgs.AddArg("-cleanblockindex=<n>", "Clean block index. 0 = disabled, 1 = enabled (default: enabled)", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/nasdaccryptocoin/nasdaccryptocoin>";

    return (strprintf(_("Copyright (C) %i The NASDAC Crypto Coin Core Developers").translated, COPYRIGHT_YEAR) + " ") +
           "\n" +
           (strprintf(_("Copyright (C) %i The BitcoinPos Core Developers").translated, COPYRIGHT_YEAR) + " ") +
           "\n" +
           strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers").translated, COPYRIGHT_YEAR) + " " + "\n" +
           "\n" +
