...
const char * const BITCOIN_CONF_FILENAME = "nasdaccryptocoin.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\NasdacCryptoCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\NasdacCryptoCoin
    // Mac: ~/Library/Application Support/NasdacCryptoCoin
    // Unix: ~/.nasdaccryptocoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "NasdacCryptoCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/NasdacCryptoCoin";
#else
    // Unix
    return pathRet / ".nasdaccryptocoin";
#endif
#endif
}
